...
export function ProspectToolsModal({ prospectId, prospectLabel }: { prospectId: string; prospectLabel: string }) {
  ...
  return <>
    ...
    {tool && active ? (
      <div className="fixed inset-0 z-[110] flex items-center justify-center bg-navy-900/45 p-3 md:p-5" role="dialog" aria-modal="true" aria-label={`${active.title} — ${prospectLabel}`}>
