...
export default async function ResiliationPopupPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="min-h-screen bg-white p-5 md:p-7">
    <div className="mb-5">
      <h1 className="font-display text-xl font-bold text-navy-800">Lettre de résiliation</h1>
    ...
    <form action="/api/outils/resiliation" method="post" target="_blank" className="rounded-xl border border-navy-100 bg-white p-5">
      ...
      <div className="mt-5 flex justify-end"><button type="submit" className="inline-flex h-10 items-center rounded-lg bg-star-500 px-4 text-sm font-semibold text-white hover:bg-star-600">Générer la lettre PDF</button></div>
    </form>
  </main>;
}
