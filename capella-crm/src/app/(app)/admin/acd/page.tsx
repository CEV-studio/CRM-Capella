...
type RequestRow={id:string;prospect_id:string;requested_by:string|null;status:string;raison_sociale:string;siren:string;siret:string;company_address:string;company_postal_code:string;company_city:string;signatory_first_name:string;signatory_last_name:string;signatory_email:string;signatory_phone:string;signatory_capacity:string;signatory_role:string;notes:string|null;submitted_at:string};
type MeterRow={id:string;request_id:string;energy_type:string;identifier:string;contract_expiry:string;address:string;postal_code:string;city:string;position:number};
